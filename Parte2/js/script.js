      ...
      /*
        ...
        */
        ...
        let boton = document.getElementById("btn_mayusculas").addEventListener("click", convert)
        
        function convert(e, a) {
          e.preventDefault()
          let nombres = document.getElementById("txt_may")
          const may = nombres.map(nombres.toLowerCase())
          document.getElementById("txt_may").value = array
        }
    ...
    */
        ...
        function calculateDogAge(e) {
          e.preventDefault()
          let edad = parseInt(document.getElementById("edad_humano").value) * 7
          document.getElementById("edad_perro").value = edad
        }
